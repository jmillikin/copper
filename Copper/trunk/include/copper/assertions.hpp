...
/**
  ...
  @return An AssertionResult
*/
Copper::AssertionResult equal(const char* expected, const char* actual)
  throw ();
Copper::AssertionResult equal(const char* expected, char actual[])
  throw ();
Copper::AssertionResult equal(char expected[], const char* actual)
  throw ();
Copper::AssertionResult equal(char expected[], char actual[])
  throw ();
...
/**
  ...
  @return An AssertionResult
*/
Copper::AssertionResult unequal(const char* bad, const char* actual)
  throw ();
Copper::AssertionResult unequal(const char* bad, char actual[])
  throw ();
Copper::AssertionResult unequal(char bad[], const char* actual)
  throw ();
Copper::AssertionResult unequal(char bad[], char actual[])
  throw ();
